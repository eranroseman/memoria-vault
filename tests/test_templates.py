"""Alpha.11 templates begin schema-valid for PI-created Concept types."""
...
def test_alpha11_templates_are_only_pi_created_types():
...
def test_templates_surface_identity_type_check_status_first():
    for tpl in sorted(TEMPLATES.glob("*.md")):
        keys = [
            line.split(":", 1)[0]
