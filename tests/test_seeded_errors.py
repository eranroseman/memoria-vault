...
def test_seeded_error_verdict_detects_and_rolls_back_structural_case(
    ...
    conflicting_doi_target = "catalog/sources/conflicting-doi/source.md"
    ambiguous_entity_target = "catalog/sources/ambiguous-entity/source.md"
    ...
    poisoned_target = "catalog/sources/poisoned-span/source.md"
