...
**Location.** `00-meta/05-dashboards/board-state.md`
...
```dataview
TABLE file.link AS Card, review_state, review_owner, review_requested_at
FROM "00-meta/board"
WHERE review_state = "requested" OR review_state = "in-review"
