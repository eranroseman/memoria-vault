...
Runtime health snapshot. Refresh occasionally — typically when something feels off or after a major config change. **Distinct from [[01-dashboards/index|the system-health dashboard]]**, which tracks work in flight; this file tracks whether the system *itself* is up.
