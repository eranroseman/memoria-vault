...
**Companion to** [Design system](https://eranroseman.github.io/memoria-vault/design/design-system) — that page describes the schema and discipline; this file *implements* it for this vault.
