...
The *why* behind a specific choice lives in an ADR. The forward plan lives in the roadmap. Both are in [project/](../project/): [decisions/](../project/decisions/) for the ADRs, [roadmap/](../project/roadmap/) for direction. *(Stubs — content coming.)*
