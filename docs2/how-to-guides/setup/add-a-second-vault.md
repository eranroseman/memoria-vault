...
```bash
hermes -p project2-librarian chat -s llm-wiki
...
- Distribution model explanation: [explanation/architecture/distribution-model.md](../../docs2/explanation/architecture/README.md)
