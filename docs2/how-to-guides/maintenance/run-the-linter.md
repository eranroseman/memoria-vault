...
- **Automatically:** the Linter runs on a cron schedule (see [standard-cron-tasks](../../memoria-vault/docs/project/roadmap/standard-cron-tasks.md)) and after each ingest batch
...
- Weekly review (lint is step 8): [run-the-weekly-review.md](run-the-weekly-review.md)
- Fix broken frontmatter: [fix-broken-frontmatter.md](../recovery/fix-broken-frontmatter.md)
- Fix profile drift: [fix-profile-drift.md](../recovery/fix-profile-drift.md)
- Linter profile design: [explanation/profiles/linter.md](../../memoria-vault/docs/explanation/profiles/linter.md)
- Severity scale: [explanation/profiles/linter.md § severity-scale](../../memoria-vault/docs/explanation/profiles/linter.md#severity-scale)
