...
- When the claim reaches `evergreen`: [how-to/workflows/upstream/promote.md](../../memoria-vault/docs/how-to/workflows/upstream/promote.md)
- Distill workflow reference: [how-to/workflows/upstream/distill.md](../../memoria-vault/docs/how-to/workflows/upstream/distill.md)
- Linking patterns: [reference/linking-patterns.md](../../memoria-vault/docs/reference/linking-patterns.md)
- Frontmatter schema: [reference/frontmatter-schema.md](../../memoria-vault/docs/reference/frontmatter-schema.md)
