...
- Ingest reference (routing table, per-type enrichment): [how-to/workflows/upstream/ingest.md](../../memoria-vault/docs/how-to/workflows/upstream/ingest.md)
- If the citekey isn't found: [Fix a stale .bib](../recovery/fix-stale-bib.md)
- Source types and note formats: [reference/note-types.md](../../memoria-vault/docs/reference/note-types.md)
