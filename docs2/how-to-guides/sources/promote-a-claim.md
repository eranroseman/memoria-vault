...
- Promote workflow reference: [how-to/workflows/upstream/promote.md](../../memoria-vault/docs/how-to/workflows/upstream/promote.md)
- MOC creation thresholds: [reference/linking-patterns.md](../../memoria-vault/docs/reference/linking-patterns.md)
