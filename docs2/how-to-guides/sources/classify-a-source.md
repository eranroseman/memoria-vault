...
- Frontmatter schema reference: [reference/frontmatter-schema.md](../../memoria-vault/docs/reference/frontmatter-schema.md)
- Vocabulary for `topic`, `methods`, `study_design`: [reference/frontmatter-schema.md](../../memoria-vault/docs/reference/frontmatter-schema.md)
