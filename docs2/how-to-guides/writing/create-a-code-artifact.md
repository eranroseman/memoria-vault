...
- Coder profile design: [explanation/profiles/coder.md](../../memoria-vault/docs/explanation/profiles/coder.md)
- External coding agent workspace: [how-to/coder/external-agent-workspace.md](../../memoria-vault/docs/how-to/coder/external-agent-workspace.md)
- Code workflow reference: [how-to/workflows/downstream/code.md](../../memoria-vault/docs/how-to/workflows/downstream/code.md)
- ADR-6 (external coding agent delegation): [project/decisions/06-code-agent-attachment.md](../../memoria-vault/docs/project/decisions/06-code-agent-attachment.md)
