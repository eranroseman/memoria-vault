...
Citation states, export routes, editor feature comparison, and deliverable folder targets. For choosing between routes and failure modes see [how-to/workflows/downstream/export-targets.md](../../docs/how-to/workflows/downstream/export-targets.md).
