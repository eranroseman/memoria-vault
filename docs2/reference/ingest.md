...
Type detection dispatch table, per-type enrichment sources, and content extraction paths for the Librarian's ingest pipeline. For the full step-by-step procedure see [how-to/workflows/upstream/ingest.md](../../docs/how-to/workflows/upstream/ingest.md).
...
| `lifecycle` | `proposed` | Promoted to `current` by the human at [Classify](../../docs/how-to/workflows/upstream/classify.md). |
| `added` | Today's date | |
