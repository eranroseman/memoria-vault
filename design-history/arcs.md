# Part IV — Synthesis: evolution arcs (alpha.1 → alpha.16)

## Evolution arcs (alpha.1 → alpha.16)
...
**Current (as of alpha.16):** No agent autonomy is part of the alpha.16 product baseline; models and agents may propose, but the engine owns writes, Guard owns egress, and `VaultWriter` owns machine file changes.

**Pending (unreleased):** Beta.1 must add the WRITE/coding modules without granting agents direct file, shell, network, or export authority.

### (b) Numbered folders (10-inbox / 02-answers) → type-first folders → state-not-folders

**Lineage:** [00-origins](00-origins.md), [01-alpha.1-baseline](01-alpha.1-baseline.md), [07-alpha.7](07-alpha.7.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md).
...
**Current (as of alpha.16):** The Memoria-born vault root uses type/function homes (`works/`, `sources/`, `notes/`, `hubs/`, `projects/`), while lifecycle/verdict state remains database state.
...
**Lineage:** [11-alpha.11](11-alpha.11.md), [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md).
...
**Current (as of alpha.16):** The released alpha.16 model keeps human `note`/`hub`/`project` concepts, splits source material into objective `works/<work_id>/record.md`/`fulltext.md`/`digest.md`, and uses human `sources/<slug>.md` source-notes to bridge the catalog graph to the knowledge graph.

**Pending (unreleased):** Beta.1 must validate the WRITE-side claim/project substrate while preserving the catalog/knowledge graph split.

### (d) Frontmatter: optional → universal enforcement (alpha.14) → meaning-only (alpha.15)

**Lineage:** [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md).
...
**Current (as of alpha.16):** Frontmatter remains meaning-only; Memoria-born markers identify machine material, while verdicts, derived state, checks, and run records live outside authored prose.
...
**Lineage:** [11-alpha.11](11-alpha.11.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md).
...
**Current (as of alpha.16):** OKF remains an interchange/keep-test boundary, not the internal representation; alpha.16's minimal export is a run-scoped structural output, not the beta.1 readiness gate.

**Pending (unreleased):** Beta.1 still needs the full output-readiness export gate if interchange is in MVP scope.

### (f) The Hermes runtime's rise (alpha.9/10) and its role by alpha.15

**Lineage:** [01-alpha.1-baseline](01-alpha.1-baseline.md), [09-alpha.9](09-alpha.9.md), [10-alpha.10](10-alpha.10.md), [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md).
...
**Current (as of alpha.16):** Hermes is not part of the released alpha.16 runtime; the process model is a standalone engine plus on-demand `memoria serve` and credential-free workers behind Guard.
...
**Lineage:** [11-alpha.11](11-alpha.11.md), [12-alpha.12](12-alpha.12.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md).
...
**Current (as of alpha.16):** SQLite owns records, derived indexes, checks, runs, jobs, costs, incidents, Guard logs, and provider payload metadata; markdown/PDF/BibTeX own the human keep-set and survival artifacts.

**Pending (unreleased):** Beta.1 must exercise crash/rebuild behavior on the full read/write output path.

### (h) Enrichment / graph (DOI, OpenAlex, Crossref — alpha.13/14)

**Lineage:** [13-alpha.13](13-alpha.13.md), [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md).
...
**Current (as of alpha.16):** Capture is land-first and provider-provenanced; Zotero/DOI/PDF/GitHub/local sources land immutable artifacts or visible triage stubs, and enrichment still never silently merges identities.

**Pending (unreleased):** Beta.1 must decide the minimum provider/discovery set needed for the full read/write MVP.

### (i) UI / navigation — the alpha.7 clean-slate

**Lineage:** [07-alpha.7](07-alpha.7.md), [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md).
...
**Current (as of alpha.16):** The required surface remains engine/read-API first; Ask/Review may have a provisional Obsidian pane, but acceptance is host-neutral through `memoria ... --json` and the read API.

**Pending (unreleased):** Beta.1 must settle the host/stack and workspace/gate model for the full read/write MVP.
...
**Lineage:** [00-origins](00-origins.md) through [16-alpha.16](16-alpha.16.md), plus this living synthesis.
...
**Current (as of alpha.16):** Alpha.16 is the current released/checkpoint technical baseline; release close now requires a frozen chapter, updated arcs, and an updated latest-checkpoint marker in `design-history/README.md`.
