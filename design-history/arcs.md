# Part IV — Synthesis: evolution arcs (alpha.1 -> alpha.17)

## Evolution arcs (alpha.1 -> alpha.17)
...
**Lineage:** [01-alpha.1-baseline](01-alpha.1-baseline.md), [07-alpha.7](07-alpha.7.md), [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md), [17-alpha.17](17-alpha.17.md).
...
**Current (as of alpha.17):** No agent autonomy is part of the product baseline; models and agents may propose, but the engine owns writes, Guard owns egress, `VaultWriter` owns machine file changes, and alpha.17's WRITE loop still routes through operations rather than direct agent file authority.
...
**Lineage:** [00-origins](00-origins.md), [01-alpha.1-baseline](01-alpha.1-baseline.md), [07-alpha.7](07-alpha.7.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md), [17-alpha.17](17-alpha.17.md).
...
**Current (as of alpha.17):** The Memoria-born vault root uses type/function homes (`works/`, `sources/`, `notes/`, `hubs/`, `projects/`), while lifecycle/verdict state remains database state; alpha.17's `outline.md`/`draft.md` artifacts live under the project rather than encoding state in folders.
...
**Lineage:** [11-alpha.11](11-alpha.11.md), [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md), [17-alpha.17](17-alpha.17.md).
...
**Current (as of alpha.17):** The model keeps human `note`/`hub`/`project` concepts, splits source material into objective `works/<work_id>/record.md`/`fulltext.md`/`digest.md`, and uses human `sources/<slug>.md` source-notes to bridge the catalog graph to the knowledge graph; draft write-back creates ordinary unchecked notes, not a new concept type.
...
**Lineage:** [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md), [17-alpha.17](17-alpha.17.md).
...
**Current (as of alpha.17):** Frontmatter remains meaning-only; Memoria-born markers identify machine material, while verdicts, derived state, checks, and run records live outside authored prose. Alpha.17 adds evidence-set markers to drafts but rejects a new frontmatter verdict/maturity field.
...
**Lineage:** [11-alpha.11](11-alpha.11.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md), [17-alpha.17](17-alpha.17.md).
...
**Current (as of alpha.17):** OKF remains an interchange/keep-test boundary, not the internal representation; alpha.17's draft export is a verified project output path, not a full publication/interchange release gate.
...
**Lineage:** [01-alpha.1-baseline](01-alpha.1-baseline.md), [09-alpha.9](09-alpha.9.md), [10-alpha.10](10-alpha.10.md), [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md), [17-alpha.17](17-alpha.17.md).
...
**Current (as of alpha.17):** Hermes is not part of the runtime; the process model is a standalone engine plus on-demand `memoria serve`, CLI/read-API operations, and credential-free workers behind Guard.
...
**Lineage:** [11-alpha.11](11-alpha.11.md), [12-alpha.12](12-alpha.12.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md), [17-alpha.17](17-alpha.17.md).
...
**Current (as of alpha.17):** SQLite owns records, derived indexes, checks, runs, jobs, costs, incidents, Guard logs, provider payload metadata, and rebuildable `evidence_sets`; markdown/PDF/BibTeX own the human keep-set and survival artifacts, with evidence markers as the canonical draft-side source for evidence-set rows.
...
**Lineage:** [13-alpha.13](13-alpha.13.md), [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md), [17-alpha.17](17-alpha.17.md).
...
**Current (as of alpha.17):** Capture is land-first and provider-provenanced; Zotero/DOI/PDF/GitHub/local sources land immutable artifacts or visible triage stubs, enrichment still never silently merges identities, and draft source-span refs use stable `work_id` rather than citekeys.

**Pending (unreleased):** Future discovery work must decide the minimum provider/discovery set needed beyond alpha.17's bounded exploration channel.

### (i) UI / navigation — the alpha.7 clean-slate

**Lineage:** [07-alpha.7](07-alpha.7.md), [14-alpha.14](14-alpha.14.md), [15-alpha.15](15-alpha.15.md), [16-alpha.16](16-alpha.16.md), [17-alpha.17](17-alpha.17.md).
...
**Current (as of alpha.17):** The required surface remains engine/read-API first; slice, compose, verify, export, exploration, and write-back all have host-neutral CLI/read-API paths. A future Obsidian plugin is recommended as a thin rendering adapter, not shipped alpha.17 scope.
...
**Current (as of alpha.17):** Alpha.17 is the current closed checkpoint technical baseline; release close requires a frozen chapter, updated arcs, an updated latest-checkpoint marker in `design-history/README.md`, and deletion of the scratch release workspace after durable routing.
