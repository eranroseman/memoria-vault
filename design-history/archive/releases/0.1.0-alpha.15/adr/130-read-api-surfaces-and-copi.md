...
- Design index Source Map and Scope Boundary; ADR-128 (attention surface
  obligations); exec-plan second wave (transports after the dogfood checkpoint;
  plugin implementation requires a future adapter ADR).
