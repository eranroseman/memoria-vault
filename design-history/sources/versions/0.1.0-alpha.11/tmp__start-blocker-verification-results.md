...
| worker queue operation dispatch | pass | fixture=/tmp/memoria-alpha11-start-blockers/worker-dispatch; queued_status=pending; done_status=done; engine=bm25; sources=['knowledge/notes/checked.md']; checked_only=True; done_file=True; memoria_test_ready={'queue_root': True, 'knowledge_root': True, 'capability_policies': True, 'answer_query_policy_checked': True, 'policy_error': 'none'}; memoria_test_dispatch={'attempted': True, 'job_id': 'start-blocker-live-answer-query-20260629T145016', 'queued_status': 'pending', 'done_status': 'done', 'done_file': True} |
