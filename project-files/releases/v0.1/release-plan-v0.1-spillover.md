...
The week-by-week ramp from [Memoria v0.1](../../plans/README.md) to production corpus use, plus the four implementation phases that structure the work. Memoria v0.1 is the full system — all folders, templates, profiles, dashboards, and the Kanban board are stood up in weeks 1–2; subsequent weeks are about corpus density, not system assembly.
