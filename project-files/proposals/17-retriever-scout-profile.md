...
- At high discovery volume (e.g., the [discovery loop](../roadmap/future-directions.md) <!-- TODO: reorg link — no unique new target for roadmap/future-directions.md --> running at scale), Librarian's classifier and discovery scoring might compete for compute; if so, split then.
...
- **Workflows affected:** [Find](../../how-to/workflows/upstream/find.md) <!-- TODO: reorg link — no unique new target for how-to/workflows/upstream/find.md -->, [Ingest](../../how-to/workflows/upstream/ingest.md) <!-- TODO: reorg link — no unique new target for how-to/workflows/upstream/ingest.md -->
