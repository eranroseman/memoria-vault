...
Never a global flag. Opt-in per `code-note`, and only for code whose success is a verifiable scalar (tests, a metric) — the Coder-lane autonomy boundary of [ADR-32](../decisions/32-l3-autonomy-ceiling.md). Synthesis work is out of scope by construction.
...
- **Bounded by:** [ADR-32 L3 autonomy ceiling](../decisions/32-l3-autonomy-ceiling.md) (the Coder exception).
