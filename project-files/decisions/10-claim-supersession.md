...
- **Workflows affected:** [Distill](../../how-to/workflows/upstream/distill.md) <!-- TODO: reorg link — no unique new target for how-to/workflows/upstream/distill.md -->, [Promote](../../how-to/workflows/upstream/promote.md) <!-- TODO: reorg link — no unique new target for how-to/workflows/upstream/promote.md --> (where the link is set), [Verify](../../how-to/workflows/downstream/verify.md) <!-- TODO: reorg link — no unique new target for how-to/workflows/downstream/verify.md --> and the Linter (FAMA-style check), [Query](../../how-to/workflows/downstream/query.md) <!-- TODO: reorg link — no unique new target for how-to/workflows/downstream/query.md --> / [Write](../../how-to/workflows/downstream/write.md) <!-- TODO: reorg link — no unique new target for how-to/workflows/downstream/write.md --> (filter superseded claims).
- **Files affected:** [vault/frontmatter-schema.md](../../reference/frontmatter-schema.md) <!-- TODO: reorg link — no unique new target for reference/frontmatter-schema.md --> (add the relation), [vault/note-types.md](../../reference/note-types.md) <!-- TODO: reorg link — multiple new targets for note-types.md (reference/ and explanation/knowledge/) --> + `00-meta/03-templates/claim-note.md`, the Linter's `M-detectors.md` (in the starter vault).
...
- **Source discussion:** benchmark review — [roadmap/evaluation.md](../roadmap/evaluation.md) <!-- TODO: reorg link — no unique new target for roadmap/evaluation.md --> (Change 1) and [roadmap/evaluation-benchmarks.md](../roadmap/evaluation-benchmarks.md) <!-- TODO: reorg link — no unique new target for roadmap/evaluation-benchmarks.md -->; evidence from Memora/FAMA and ClawArena.
