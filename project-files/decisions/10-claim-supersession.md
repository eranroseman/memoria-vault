...
- **Files affected:** [vault/frontmatter.md](../../docs/reference/frontmatter.md) (add the relation), [vault/note-types.md](../../docs/reference/note-types.md) + `00-meta/03-templates/claim-note.md`, the Linter's `M-detectors.md` (in the starter vault).
