...
- **Workflows affected:** [Distill](../../how-to/workflows/upstream/distill.md), [Promote](../../how-to/workflows/upstream/promote.md) (where the link is set), [Verify](../../how-to/workflows/downstream/verify.md) and the Linter (FAMA-style check), [Query](../../how-to/workflows/downstream/query.md) / [Write](../../how-to/workflows/downstream/write.md) (filter superseded claims).
- **Files affected:** [vault/frontmatter-schema.md](../../reference/frontmatter-schema.md) (add the relation), [vault/note-types.md](../../reference/note-types.md) + `00-meta/03-templates/claim-note.md`, the Linter's `M-detectors.md` (in the starter vault).
