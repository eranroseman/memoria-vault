...
- **Supporting rationale:** [why-not-autonomous.md](../../docs/explanation/architecture/why-not-autonomous.md) (the preconditions argument and the Coder exception), [why-human-gate.md](../../docs/explanation/architecture/why-human-gate.md), [what-memoria-is.md](../../docs/explanation/what-memoria-is.md) (autonomy-spectrum positioning, "vibe researching").
