...
- **Supporting rationale:** [what-memoria-is.md](../../docs/explanation/what-memoria-is.md) ("single researcher" and "not a team tool in its current form").
