// Pure empirical_event.v1 validation and item-id sanitization. No Obsidian
// imports; headless-testable with node. The engine's roster
// (src/memoria_vault/engine/empirical_events.py) is the source of truth; these
// enums are the subset an Obsidian client can legitimately submit, narrowed the
// same way SURFACES is pinned to "obsidian" alone. Widen one only alongside the
// call-site that emits the value; tests/test_memoria_obsidian_package.py pins
// the subset against the engine.
