...
- Contradictory and supporting claims are recorded as **typed links** in the `relations:` frontmatter (`contradicts` / `supports`), not just here — see [schema reference](../schema-reference.md).
