...
- Contradictory and supporting claims are recorded as **typed links** in the `relations:` frontmatter (`contradicts` / `supports`), not just here — see [frontmatter reference](https://eranroseman.github.io/memoria-vault/reference/frontmatter/).
