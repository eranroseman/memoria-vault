...
**For depth:** [the folder-permission matrix](https://eranroseman.github.io/memoria-vault/reference/profiles/#folder-permission-matrix) — the authoritative matrix. [the policy MCP reference](https://eranroseman.github.io/memoria-vault/reference/policy-mcp/) — the runtime gate.
