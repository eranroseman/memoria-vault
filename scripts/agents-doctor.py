...
GENERATED = "<!-- Generated by scripts/agents-doctor.py; edit the source YAML instead. -->"
REQUIRED_FILES = (
    "README.md",
...
def check(write: bool = False) -> list[str]:
    ...
    for path, expected in rendered.items():
        if write:
            ...
            errors.append(f"{path.relative_to(ROOT)}: stale; run scripts/agents-doctor.py --write")
    return errors
