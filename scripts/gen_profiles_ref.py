...
LANES = ROOT / "vault-template/.memoria/lane-overrides"
TASKS_MCP = ROOT / "vault-template/.memoria/mcp/tasks_mcp.py"
...
def render_tables() -> str:
    ...
    lines = [
        ...
        "`vault-template/.memoria/lane-overrides`, `vault-template/.memoria/tool-registry.yaml`, and "
