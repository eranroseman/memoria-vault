...
In Obsidian: `Cmd-P → Templater: Insert template → screening-protocol`. The template is at `00-meta/04-reference/screening-protocol.md`.
...
- The screening-protocol template: `00-meta/04-reference/screening-protocol.md`
