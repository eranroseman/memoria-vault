...
Open the Inbox gate's **Needs me** view and resolve the card: keep the source (resolve to `current`) or archive it. Resolving is one palette command — [Work the review queue](../inbox/work-the-review-queue.md).
