...
nav_order: 5
has_children: true
permalink: /how-to-guides/project/
---

# Project

Steer an inquiry to output — scope, frame, draft, verify, and export a deliverable. Performed inside Obsidian via the Co-PI pane and the Inbox; export runs in the terminal. The Project gate gives the work a bounded project folder, active thesis, and saturation signal.
