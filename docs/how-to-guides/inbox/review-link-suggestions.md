...
If the lane also raised cards, open the **Needs me** view of `inbox/inbox.base` on the Inbox space. Triage the batch together — the one-pass discipline keeps your judgment sharp ([ADR-54](../../adr/54-two-decision-kinds-batch-worklists.md)).
