...
It is deliberately *not* a scoring matrix — there are no weights and no expected-method/design fields. That richer config was considered and rejected as drift-prone ([ADR-15](../../../project/decisions/15-project-auto-classification.md)); a hint is just a topic list.
...
- The decision and its rationale: [ADR-15](../../../project/decisions/15-project-auto-classification.md)
