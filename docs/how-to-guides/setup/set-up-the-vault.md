...
All seven `memoria-*` profiles appear in the output. If a profile is missing, the script reported that its required files weren't present — check [implementation-status.md](../../../project-files/plans/implementation-status.md) for what's currently wired.
...
- Implementation status: [implementation-status.md](../../../project-files/plans/implementation-status.md)
