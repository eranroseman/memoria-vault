...
All seven `memoria-*` profiles appear in the output. If a profile is missing, the script reported that its required files weren't present — check the [v0.1 release plan](../../../project/release/v0.1/release-plan-v0.1.md) for what's currently wired.
...
- Build status: [v0.1 release plan](../../../project/release/v0.1/release-plan-v0.1.md)
