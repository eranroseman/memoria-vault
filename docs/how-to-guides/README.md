...
| [Run a systematic review](sources/run-a-systematic-review.md) | PRISMA-compliant protocol → screening → ingest for defensible literature searches | Find → Screen → Ingest |
...
| [Work the review queue](writing/work-the-review-queue.md) | Approve or reject agent writes held at the review gate | Review |
