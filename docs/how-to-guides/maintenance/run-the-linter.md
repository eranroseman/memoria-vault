...
- **Automatically:** the Linter runs on a cron schedule (see [standard-cron-tasks](../../../project-files/operations/timeline.md)) and after each ingest batch
...
- Linter profile design: [explanation/profiles/linter.md](../../explanation/profiles/linter.md)
