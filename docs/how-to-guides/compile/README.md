...
| --- | --- | --- |
| [Find new sources](find-new-sources.md) | Delegate a discovery run; judge the candidate cards | Find |
...
| [Review link suggestions](review-link-suggestions.md) | Triage the link lane's Inbox proposals — approve or reject | Connect |
| [Advance a claim to evergreen](promote-a-claim.md) | Mark a settled claim `maturity: evergreen`; handle supersession | Maintenance |
| [Archive a source](archive-a-source.md) | Retire an outdated or superseded source by lifecycle | Maintenance |
| [Run a systematic review](run-a-systematic-review.md) | PRISMA protocol → screening → capture for defensible searches | Screen (opt-in) |
