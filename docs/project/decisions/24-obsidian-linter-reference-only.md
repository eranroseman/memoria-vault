...
- **Files affected:** [obsidian-plugins/reference/obsidian-linter.md](../evaluated-alternatives/obsidian-linter.md) (moved from `recommended/`), [obsidian-plugins/README.md](../../reference/plugins/README.md) (recommended 11→10, reference 3→4).
...
- **Related decisions:** the frontmatter namespace discipline this protects ([frontmatter-schema.md](../../reference/frontmatter-schema.md)).
