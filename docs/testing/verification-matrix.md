...
| 6 | Hermes runtime, gateway, cron, profile registry, model endpoint, and MCP servers are live. | [Runtime](plans/runtime-gate.md) | `scripts/verify runtime` plus manual S4 checks. | partial | partial |
