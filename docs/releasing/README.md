...
the latest completed checkpoint is [v0.1.0-alpha.9](0.1.0-alpha.9/), with earlier
checkpoints under the same folder. Alpha checkpoints are internal milestones,
not formal releases. The *live readiness state* lives outside the file — see below.
