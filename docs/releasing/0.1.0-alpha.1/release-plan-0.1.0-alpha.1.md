...
| G8 | todo | `CHANGELOG.md` `[0.1.0-alpha.1]` entry written at cut; version `0.1.0-alpha.1` consistent across the 7 `distribution.yaml` | manual | — |
...
| Gate | State | Proves | Verified by | Issue |
| --- | --- | --- | --- | --- |
| G9 | awaiting-verify | **Dispatched-card spine.** The dispatch → claim → run → gated write → audit → `done` loop is now **proven live** — the G10 ingest card completed it end-to-end on installer-deployed lanes. The fresh-clone candidate re-run remains to record it cleanly | [G9 plan](../../testing/plans/g9-spine-plan.md) | — |
