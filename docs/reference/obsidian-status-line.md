...
The ambient indicator showing Linter findings and Kanban queue counts. Rendered as a Dataview widget pinned in `00-meta/start-here.md`, not the OS status bar (which Dataview cannot write to).
