...
**Precedence.** When a runtime template (`99-system/templates/*.md`) disagrees with this file, this file governs — the template is what must change. When in doubt, the [v0.1 release plan](../../project/releases/v0.1/release-plan-v0.1.md) tracks build state.
...
Transient leads / ingestion dead-letters in `10-inbox/03-candidates/` ([ADR — shared candidate frontmatter](../../project/decisions/17-shared-candidate-frontmatter.md)).
