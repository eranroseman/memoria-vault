...
**Precedence.** When a runtime template (`99-system/templates/*.md`) disagrees with this file, this file governs — the template is what must change. When in doubt, [Implementation status](../../project-files/implementation-status.md) tracks build state.
