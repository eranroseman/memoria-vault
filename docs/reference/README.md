...
| [Dashboards](analysis-and-surfaces/dashboards.md) | CLI/read-API surface inventory: Inbox, Maintenance, corpus views, support views, verdict bands, and rail badges | Manual |
