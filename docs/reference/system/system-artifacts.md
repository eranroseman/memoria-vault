...
| --- | --- | --- |
| `index.md` | Generated OKF v0.2 bundle-root index over the current bundle roots. | [Operations](../commands-and-transports/operations.md) |
...
`bibliography.bib` is generated from checked SQLite catalog rows, and the
root, workspace `index.md` — the OKF v0.2 bundle-root index, whose only
frontmatter key is the `okf_version: "0.2"` declaration — is generated from
checked Concept files. The tracked projection drift check covers all
committed projections. Packaged
