...
has no PI request-control or evidence-disposition endpoint.
...
authority, including the PI-reserved operations in the
...
keeps actor `agent`. The transport records write provenance as:
