...
**Partially generated.** The folder-control and calibration summary tables are
regenerated by `python scripts/gen_reference_refs.py --write`; edit
`src/.memoria/schemas/`, not the generated tables.
