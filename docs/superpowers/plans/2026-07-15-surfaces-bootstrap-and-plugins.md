...
> amendment above replaces this earlier, weaker nested-card test/body. It is kept
> only as drafting history. Before V2R-B.3 or V2R-D.2 can execute, `renderCard`
> must render every supplied
