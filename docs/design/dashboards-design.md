...
[`vault/00-meta/01-dashboards/`](../../src/00-meta/01-dashboards) and the
...
> [Measurement, quality, and verification](measurement-and-verification.md). This is the
...
- [Structural linter and drift detection — zero-LLM vault health](structural-linter-and-drift.md) — `drift-watch` / `loose-ends` findings
