...
[`vault/.memoria/mcp/ingest_mcp.py`](../../../vault/.memoria/mcp/ingest_mcp.py) and
the [`obsidian-paper-note`](../../../vault/.memoria/profiles/memoria-librarian/skills/obsidian-paper-note/)
...
1. **Classification.** From the abstract / tldr / extract, propose
   ...
   [`00-meta/vocabulary.md`](../../../vault/00-meta/vocabulary.md) — prefer a defined
...
- [classical-method-displacements.md](classical-method-displacements.md) — the classifier / NLI methods behind the holes
- [schema-and-retrieval.md](schema-and-retrieval.md) — the `_aspects` / paper-note schema the pipeline populates
- [profiles-and-soul-model.md](profiles-and-soul-model.md) — the Librarian lane that drives it
- Reference: [`docs/reference/ingest.md`](../../../docs/reference/ingest.md), [`zotero-plugins.md`](../../../docs/reference/zotero-plugins.md)
