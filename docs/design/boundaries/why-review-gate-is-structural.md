...
- Why operation postures support this: [Why operation postures, not a generalist agent](why-specialist-postures.md)
- Why the vault won't automate synthesis: [Why Memoria doesn't pursue full autonomy](why-not-autonomous.md)
- How request review state works: [Request states and the review gate](../../explanation/execution/control-plane/states.md)
...
- Request and attention state: [Request states and the review gate](../../explanation/execution/control-plane/states.md)
