...
- The operation postures described: [Operation postures](../../explanation/execution/operation-postures/README.md)
- The deterministic actors that are not agents: [Operations](../../explanation/execution/operations.md)
