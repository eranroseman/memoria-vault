...
> [`docs/explanation/rationale/why-pattern-provenance.md`](../explanation/rationale/why-pattern-provenance.md).
...
|---|---|---|---|
| Borrow | File-as-Bus ablation: removing the artifact bus drops PaperBench 6.41 / MLE-Bench Lite 31.82 | Chen et al. 2026 | ⚠️ unverified — also in [Memory systems and benchmarks — the evidence behind durable state](memory-systems-and-benchmarks.md) |
...
- [`docs/explanation/rationale/why-pattern-provenance.md`](../explanation/rationale/why-pattern-provenance.md) — the table this appendix backs
