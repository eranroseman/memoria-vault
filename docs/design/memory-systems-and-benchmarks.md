...
[docs/explanation/](../../../docs/explanation/) and the ADRs argue that **durable,
...
3. **The substrate mapping** — how the verified findings map onto Memoria's seven
   substrates (see [memory-substrates.md](memory-substrates.md)).
...
- [memory-substrates.md](memory-substrates.md) — the as-built substrate set this evidence underpins
- [ai-research-systems-survey.md](ai-research-systems-survey.md) — the sibling survey stub (overlapping sources)
- Explanation: [`why-three-layers.md`](../../../docs/explanation/rationale/why-three-layers.md), [`architecture/memory-model.md`](../../../docs/explanation/architecture/memory-model.md)
