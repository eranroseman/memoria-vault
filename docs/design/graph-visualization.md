...
| **Optional power-pane** (topic/gap discovery) | **InfraNodus** — deferred | best-in-class gap surfacing, but managed-service + AI calls → a _human pane_, never the agent engine (per [integrations.md](../../../docs/reference/integrations.md) + #195) |
