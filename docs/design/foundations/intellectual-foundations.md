...
[Bibliography](../../reference/bibliography.md) and the
[Pattern provenance table](../../reference/pattern-provenance.md).
...
The pattern-by-pattern judgment is in [Pattern provenance table](../../reference/pattern-provenance.md). The confident-wrong argument behind the human gate is in [Why the review gate is structural](../boundaries/why-review-gate-is-structural.md).
