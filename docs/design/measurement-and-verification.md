...
**What.** Per-lane and per-skill metrics (cost, success rate, retry rate, latency) on daily/weekly/monthly cadence. Materializes the [fleet-health dashboard](../explanation/dashboards/operational-health/fleet-health.md) design.
