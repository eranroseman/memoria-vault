...
retries safe, handoffs lossless, and review enforceable. [ADR-125](../adr/125-standalone-cli-engine-architecture.md)
...
(actor-kind). [ADR-125](../adr/125-standalone-cli-engine-architecture.md) pulled them apart
