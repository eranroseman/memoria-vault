...
*detectable* — see [session-logging-and-audit.md](session-logging-and-audit.md).
...
- [session-logging-and-audit.md](session-logging-and-audit.md) — the audit + hash-chain consumer of this engine
- [profiles-and-soul-model.md](profiles-and-soul-model.md) — the seven lanes the gate scopes
- Reference docs: [`docs/reference/policy-mcp.md`](../../../docs/reference/policy-mcp.md)
- Explanation: [`docs/explanation/architecture/control-plane.md`](../../../docs/explanation/architecture/control-plane.md), [`why-human-gate.md`](../../../docs/explanation/rationale/why-human-gate.md)
