...
- **Decisions:** [ADR-125](../adr/125-standalone-cli-engine-architecture.md) (standalone CLI + engine), [ADR-125](../adr/125-standalone-cli-engine-architecture.md) (historical repo install unit).
