...
**You will end with:** the goal you named in Tutorial 00, realized as a short, cited section — drafted from your own claim and the sample's worked claims, with every citation bound to a source you actually hold.

**Time:** 30–45 minutes.

**You will use:** Obsidian, the Co-PI pane, the project you opened in Tutorial 00, and the claim cluster you completed in Tutorial 02.
...
You already opened a project and read its coverage map in [Tutorial 00](00-orient.md); since then your cluster has grown — your own claim joined it in Tutorial 02. Now you stop accumulating and **produce**: decide what the section can stand behind, then draft it. The gap you saw on the map stays in view — a defensible section is honest about where its evidence stops.

---

## Step 1 — Decide what the section claims

The map in Tutorial 00 told you what you can stand behind. Now scope the section to it. Open the hub (`mediterranean-diet-and-cvd`) and your own claim, and decide the spine of 200 words:
...
- The gap card still in your Inbox, now named in the prose — kept for Tutorial 05
