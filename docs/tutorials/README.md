...
| --- | --- | --- | --- |
| [01](01-set-up-from-zero.md) | Set up from zero | Run the one-line installer, add your API keys, open the vault, meet the Co-PI | A working vault: five profiles installed, the Co-PI pane answering, the Library space open |
...
| [04](04-build-a-reading-batch.md) | Build a reading batch | Ask the Co-PI for a topic batch, then work the reading queue in one batch pass | A Library reading queue you work down in batches, not card by card |
| [05](05-synthesize-toward-a-writing-project.md) | Synthesize toward a writing project | Distill claims, gather them under a hub, ask for corpus coverage | Your synthesis surface: claims, a hub, and a coverage read that can feed the Project space |
| [06](06-verify-and-address-gaps.md) | Verify and address gaps | Ask for a verification pass, read the finding-first cards, let gaps re-trigger discovery | A checked corpus and your first turn of the compounding loop |
...
- [Workflows](../explanation/workflows/README.md) — how work moves through the system: the lanes, the board, and the spaces
