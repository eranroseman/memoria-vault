...
| [05](05-synthesize-toward-a-writing-project.md) | Synthesize toward a writing project | Distill claims, gather them under a hub, delegate a `map` task for coverage | Your synthesis surface: claims, a hub, and a corpus map that can feed the Project gate |
