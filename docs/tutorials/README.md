...
| [05](05-synthesize-toward-a-writing-project.md) | Synthesize toward a writing project | Distill claims, gather them under a hub, delegate a `map` task for coverage | Your synthesis surface: claims, a hub, and a corpus map that can feed the Project space |
| [06](06-verify-and-address-gaps.md) | Verify and address gaps | Delegate a `verify` task, read the finding-first cards, let gaps re-trigger discovery | A checked corpus and your first turn of the compounding loop |
