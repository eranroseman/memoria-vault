...
| [03 — Bring in a paper](tutorials/03-bring-in-a-paper.md)                | Optionally wire Zotero, capture a paper, judge its candidate card, fill a source note | A Catalog entity, a kept candidate, and a source note in your own words |
...
| [05 — Synthesize toward a writing project](tutorials/05-synthesize-toward-a-writing-project.md)  | Distill claims, gather them under a hub, delegate a `map` task for coverage | Your synthesis surface: claims, a hub, and a corpus map that can feed the Project gate |
