...
- **Related decisions / Depends on:** [ADR-129 (layered machine judgment)](129-layered-machine-judgment.md) (the drift gold tasks exercise its FAMA check); [ADR-129 (layered machine judgment)](129-layered-machine-judgment.md) and [ADR-126 (four-type knowledge model)](126-four-type-knowledge-model.md) (shared observability lineage).
