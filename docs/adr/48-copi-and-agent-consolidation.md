...
**0.1.0-alpha.2 ships all five profiles** (the original plan shipped only Co-PI + Librarian,
with the rest deferred to 0.1.0-alpha.3; the PI expanded the scope mid-build — 2026-06-09 — so
Writer, Peer-reviewer, and Engineer landed in 0.1.0-alpha.2 as well; their *Project-workspace
workflows* still arrive with 0.1.0-alpha.3).
