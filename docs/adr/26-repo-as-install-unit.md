...
- **Profiles are hand-authored**, not compiled. The seven profile directories under `.memoria/profiles/` are maintained by hand; a profile compiler is **deferred** ([RFC-09-profile-compilation.md](../rfc/RFC-09-profile-compilation.md)) because seven-profile scale does not yet justify the complexity.
...
- **Proposals:** [RFC-09-profile-compilation.md](../rfc/RFC-09-profile-compilation.md) (the deferred compiler).
- **How-to:** [redeploy-profiles.md](../../docs/how-to-guides/operate/redeploy-profiles.md), [set-up-the-vault.md](../../docs/how-to-guides/setup/set-up-the-vault.md).
