...
- *(v0.1.1)* No lane carries an autonomous keep/revert loop. Introducing one anywhere — including a future code lane — requires revisiting this ADR explicitly.
