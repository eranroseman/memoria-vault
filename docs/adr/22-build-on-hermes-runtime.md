...
- The cost is a standing dependency on an external runtime's release cadence and conventions. This is accepted deliberately, and it is why [Hermes conventions are reused verbatim](../design/why-hermes.md) rather than renamed.
