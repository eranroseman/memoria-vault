...
- **Supporting rationale:** [Why Hermes](../design/why-hermes.md) (what Hermes provides, the boundary table, the API surface), [Why the architecture is layered](../design/why-three-layers.md) (thin-control-over-thick-state), [Pattern provenance: borrow, adapt, ignore](../design/why-pattern-provenance.md) (this as a deliberate "borrow").
