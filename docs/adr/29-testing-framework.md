...
1. **Coverage matrix is the keystone.** [`coverage-matrix.md`](../../project/test/coverage-matrix.md) maps every design component → its layer/plan → automated? → release gate. Gaps are tracked, not discovered by accident.
