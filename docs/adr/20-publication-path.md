...
- **Files affected:** [Telemetry & logs](../reference/telemetry.md) (the six-signal schemas), [Release plan — 0.1.0-alpha.1 — appendix](https://github.com/eranroseman/memoria-vault/blob/main/docs/releasing/0.1.0-alpha.1/release-plan-0.1.0-alpha.1-appendix.md) (step 8, six-signal capture; board-export cron is the prerequisite).
