...
- **Proposals:** [Measurement, quality, and verification](../design/measurement-and-verification.md) (analysis harnesses, deferred); [ADR-41](41-configurable-review-gate-mode.md) (the comparison arm).
