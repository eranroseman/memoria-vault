...
| --- | --- | --- |
| **golden-copy** | **Keep — built** | `engines/linter/golden.py` (stage / check / restore) on the daily lint cron ([ADR-55](55-src-scaffold-populate-golden-copy.md)). |
