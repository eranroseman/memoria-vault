...
- **Adjacent future idea:** the read-only [Memoria Inspector Obsidian plugin](../design/integrations.md) covers part of the same forensic need from inside Obsidian
