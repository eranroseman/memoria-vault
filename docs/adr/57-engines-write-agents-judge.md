...
(ADR-46, ADR-48; the [task classification](../design/why-deterministic-methods.md))
...
- Some tasks sit on the boundary (e.g. summarize-then-file); the
  [task classification](../design/why-deterministic-methods.md) default
...
- **Reinforces:** [ADR-30](30-deterministic-ingest-pipeline.md) (scriptable-before-LLM),
  ...
  prompt discipline).
- **Rationale page:** [Why Memoria uses deterministic methods alongside LLMs](../design/why-deterministic-methods.md).
