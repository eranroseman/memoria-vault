...
Do not adopt early. The gate is useless on an empty or early vault and cannot be tuned without real false-positive data; building it before the corpus warrants it adds friction at the most creative moment (capturing a new idea) for no benefit.
