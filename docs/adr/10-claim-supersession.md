...
- **Source discussion:** benchmark review — [measurement-and-verification.md](../rfc/explorations/measurement-and-verification.md) (Change 1, and the benchmark detail); evidence from Memora/FAMA and ClawArena.
