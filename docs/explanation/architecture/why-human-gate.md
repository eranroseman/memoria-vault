...
Agents (Verifier, Linter) can attach a recommendation — `metadata.agent_verdict` — to a finished card. This recommendation is deliberately separate from the review decision:
