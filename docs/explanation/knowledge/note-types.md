...
(A `candidate-note` — a source the Librarian surfaces during discovery, awaiting screening — is a proposed **16th** type, deferred; it is not part of the canonical fifteen. Session logs and verification reports are workflow *artifacts*, not note types.)
