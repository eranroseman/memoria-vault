...
| [What checked means](what-checked-means.md)                       | The three-value runtime verdict, checked-only file reads, and why checked eligibility remains separate from truth, PI disposition, citation, evidence resolution, and export readiness. |
