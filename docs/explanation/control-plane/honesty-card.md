...
| --- | --- |
| Classification | It is audited, correctable metadata; gating it would be a rubber stamp ([ADR-128](../../adr/128-no-write-time-correctness-oracle.md)). |
