...
- **Distribution-model change:** `vault/` stops being independently distributable. Acceptable because the real workflow is cloning the whole repo, but it is a deliberate reversal recorded in [ADR-26](../../adr/26-repo-as-install-unit.md) and [Distribution model](distribution-model.md).
...
- **Decisions:** [ADR-26 the repo is the install unit](../../adr/26-repo-as-install-unit.md).
