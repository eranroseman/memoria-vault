...
nav_order: 5
has_children: true
permalink: /explanation/rationale/deployment/
grand_parent: Explanation
---

# Deployment

These pages explain why Memoria ships as a standalone workspace and what remains
outside the supported deployment boundary.
