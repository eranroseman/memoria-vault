...
> **Planned beta.1:** strict OKF conformance and copyable bundle boundary are target-state.
...
> **Planned beta.1:** detachability enforcement and complete project-close harvest/archive lifecycle are target-state.
...
- Term lookup for the jargon used here: [Glossary](../../../reference/data-model/glossary.md)
