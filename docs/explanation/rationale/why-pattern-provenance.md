...
| **"Persistent knowledge accumulation is the #1 barrier to L5"** | [Chen 2026](../../reference/bibliography.md#chen2026copilots) (*From Copilots to Colleagues*) | Independent validation of Memoria's vault-as-load-bearing-piece thesis from a 95-paper survey. Chen identifies as the field's open problem exactly what Memoria's central commitment addresses. |
