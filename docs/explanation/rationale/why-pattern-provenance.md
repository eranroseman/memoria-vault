...
| **Cross-run knowledge accumulation** | [PARNESS (Wang and Luan 2026)](../../reference/bibliography.md#wang2026parness) | Third independent corroboration of the durable-state thesis. PARNESS names "no existing tool persists cross-run knowledge in a form retrievable into a finite LLM context" as one of five structural problems in the field and addresses it with a persistent knowledge layer. | Vault layer; see [why-three-layers.md](why-three-layers.md). |
...
| **Hypothesis-feedback taxonomy** | [MOOSE (Yang et al. 2024)](../../reference/bibliography.md#yang2026moose) | Three-channel feedback structure (present / past / future claim types) is a useful rubric for structuring verification prompts. | Borrowed as a prompt-design input for the Verifier; the autonomous quality gate that uses this taxonomy in MOOSE is not adopted. |
