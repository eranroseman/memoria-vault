...
- Which posture handles which task type: [Why operation postures](why-operation-postures.md)
- The zero-LLM operation this rationale produces: [The Linter](../../execution/operations.md)
- [Retrieval and analysis methods](../../../reference/analysis-and-surfaces/retrieval-and-analysis-methods.md) — the catalog of specific deterministic methods Memoria uses
