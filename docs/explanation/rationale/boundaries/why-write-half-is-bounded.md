...
The [design principles](../foundations/design-principles.md) name the governing
...
- The cycle this completes: [The knowledge cycle](../../knowledge/knowledge-cycle.md)
- The project slice file: [The knowledge cycle](../../knowledge/knowledge-cycle.md#project-slices)
- The draft posture: [The Writer](../../execution/operation-postures/writer.md)
- Export behavior: [Export routes and formats](../../../reference/pipelines-and-io/export.md)
