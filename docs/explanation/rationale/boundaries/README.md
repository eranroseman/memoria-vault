...
nav_order: 2
has_children: true
permalink: /explanation/rationale/boundaries/
grand_parent: Explanation
---

# Boundaries

The boundary pages explain what Memoria lets agents do, what it refuses to
delegate, and where structural enforcement replaces prompt discipline.
...
| [Why operation postures](why-operation-postures.md) | Why Memoria has one read-only conversational posture plus scoped operation postures |
