...
[Feng et al. 2025](../../reference/bibliography.md#feng2025levels)'s (*Levels of Autonomy for AI Agents*) five-level taxonomy: L1 (autocomplete) → L2 (multi-step, human approval per step) → L3 (multi-step autonomous, human-set strategy, per-batch review) → L4 (self-directed within a domain) → L5 (fully self-directed).
