...
diagnosis of thin or contested areas ([Note body structure](../../knowledge/note-body-structure.md#why-hubs-answer-three-distinct-questions)).
...
([Wikilink and link conventions](../../../reference/data-model/wikilink-and-link-conventions.md#hub-thresholds)).
...
- The folder-light, link-first organization that makes hubs necessary: [Lifecycle and state](lifecycle-and-state.md)
- What the three hub body sections each make the note able to do: [Note body structure](../../knowledge/note-body-structure.md#why-hubs-answer-three-distinct-questions)
- The hub-as-folder-dump failure mode: [Common pitfalls](../../knowledge/common-pitfalls.md)
- The machine surfaces a hub is *not*: [Search](../../../reference/pipelines-and-io/search.md#graph-aware-retrieval-and-clustering-boundary)
