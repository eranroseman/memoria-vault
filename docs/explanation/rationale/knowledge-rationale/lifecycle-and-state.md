...
into folder names. The full tree is catalogued in [On-disk layout](../../../reference/system/on-disk-layout.md).
...
inventories are defined in [Frontmatter fields](../../../reference/data-model/frontmatter.md)
and [Ingest routing](../../../reference/pipelines-and-io/ingest.md).
