...
Loudness grades the urgency of a pull-only attention projection. It is not
notification decoration: its purpose is preserving the PI's attention for items
