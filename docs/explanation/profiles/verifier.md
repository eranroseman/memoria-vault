...
- The failure mode the Verifier catches: [Common pitfalls](../knowledge/common-pitfalls.md)
...
- How gap cards close the ingest loop: [Ingest routing](../../reference/ingest.md)
