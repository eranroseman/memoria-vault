...
**Lanes are the four background agents** — Librarian, Writer, Peer-reviewer, Engineer (`assignee = memoria-<name>`). The Co-PI has no lane (it converses in the pane and delegates), and neither do the deterministic operations — why both stay off the board is in [Board states and the review gate](states.md).
