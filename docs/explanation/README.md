...
- [Dashboards](dashboards/README.md) — the space and support dashboards, grouped: daily-glance, synthesis-agenda, project-steering, structural-health, operational-health
