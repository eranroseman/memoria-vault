...
| **Command palette** | The keyboard component — every Memoria action bound to `Cmd-P → Memoria:`. | Instant; many times per day | [command-catalog.md](../../reference/command-catalog.md) |
