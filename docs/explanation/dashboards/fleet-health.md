...
- **When to enable.** Phase 6 (post-MVS) per [the roadmap](../../project/roadmap/future-directions.md). Before then, board-state and audit-log catch issues directly without aggregation overhead.
