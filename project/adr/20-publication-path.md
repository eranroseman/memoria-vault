...
- **n=1 operator data is accepted as a known weakness** of the later system-paper path, to be mitigated by detailed logging and a within-subject comparison arm (blocking vs. advisory review, see [RFC-08](../proposals/RFC-08-configurable-review-gate-mode.md)) rather than by more operators.
...
- **Proposals:** [measurement-and-verification.md](../proposals/explorations/measurement-and-verification.md) (analysis harnesses, deferred); [RFC-08](../proposals/RFC-08-configurable-review-gate-mode.md) (the comparison arm).
