...
- **Proposals bounded by this ADR:** [RFC-01-code-artifact-autopilot.md](../rfc/RFC-01-code-artifact-autopilot.md) (the keep/revert loop, admissible only within the Coder exception); [RFC-08-configurable-review-gate-mode.md](../rfc/RFC-08-configurable-review-gate-mode.md) (advisory-mode comparison arm).
