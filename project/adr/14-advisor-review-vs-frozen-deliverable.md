...
[note-types.md](../../docs/reference/note-types.md)). The current export path emits one thing: a
...
documented in [export a draft](../../docs/how-to-guides/compose/export-a-draft.md); the
...
- **Workflows affected:** [export a draft](../../docs/how-to-guides/compose/export-a-draft.md) (companion how-to, added with this ADR), [export.md](../../docs/reference/export.md) (the existing static path)
