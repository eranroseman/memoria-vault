...
- **Workflows affected:** [Distill](../../docs/how-to-guides/compile/write-a-claim-note.md), [Promote](../../docs/how-to-guides/compile/promote-a-claim.md) (where the link is set), [Verify](../../docs/how-to-guides/compose/verify-and-revise.md) and the Linter (FAMA-style check), [Query](../../docs/how-to-guides/compose/query-the-vault.md) / [Write](../../docs/how-to-guides/compose/draft-with-writer.md) (filter superseded claims).
...
- **Source discussion:** benchmark review — [measurement-and-verification.md](../proposals/explorations/measurement-and-verification.md) (Change 1, and the benchmark detail); evidence from Memora/FAMA and ClawArena.
