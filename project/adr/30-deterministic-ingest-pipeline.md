...
- **Workflows affected:** [capture-and-ingest.md](../../docs/how-to-guides/compile/capture-and-ingest.md), [obsidian-command-palette.md](../../docs/reference/obsidian-command-palette.md).
