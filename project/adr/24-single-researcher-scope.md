...
- **Proposals bounded by this ADR:** [multi-vault-and-multi-machine.md](../rfc/explorations/multi-vault-and-multi-machine.md) (cross-machine for one researcher is in scope; a shared multi-user memory server is not, absent a superseding decision).
