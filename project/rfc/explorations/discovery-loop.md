...
**Adoption trigger.** All four must hold: (1) Memoria v0.1 stable, (2) `research-focus.md` maintained for ≥ 4 weeks, (3) always-on deployment active (Syncthing + VPS), (4) `screening-plan.md` written down. Not before.
...
**Related.** [RFC-01 code-artifact autopilot](../RFC-01-code-artifact-autopilot.md) is the *scheduled-script* variant of Coder-lane autonomy; this is the *keep/revert experiment* variant. Both are bounded by [ADR-21](../../decisions/21-l3-autonomy-ceiling.md).
