...
> proposal touching them is the narrow [RFC-09](../RFC-09-profile-compilation.md).
...
- **No Reviewer.** An LLM reviewer is confidently wrong on exactly the hallucinated-
  ...
  [why-human-gate](../../../docs/explanation/rationale/why-human-gate.md)).
...
- [RFC-09](../RFC-09-profile-compilation.md) — compiling the seven SOULs from a shared base (deferred)
- [RFC-04](../RFC-04-retriever-scout-profile.md) — splitting Librarian into Retriever + Librarian (deferred)
- [policy-gate-and-permissions.md](policy-gate-and-permissions.md) — the path/capability scoping behind each lane
- [memory-substrates.md](memory-substrates.md) — agent memory per profile
- Explanation: [`docs/explanation/profiles/`](../../../docs/explanation/profiles/), [`why-specialist-profiles.md`](../../../docs/explanation/rationale/why-specialist-profiles.md)
