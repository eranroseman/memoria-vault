...
| [ExecPlan](templates/exec-plan.md) | Skeleton for a complex task's self-contained living plan (instances live on the `scratch` branch under `scratch/releases/<version>/`) |
